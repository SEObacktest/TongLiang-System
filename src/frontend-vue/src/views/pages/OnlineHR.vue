...
import HRList from '../components/HRList.vue';
import HRDetail from '../components/HRDetail.vue';
import AddHr from '../components/AddHr.vue';
...
<div id='main'>
    ...
    <Transition>
        <div v-if="isShowHrDetail" class="container" :class="{ container_filter: isShowHrDetail }">
            <HRDetail :hr="hrClicked" @close="isShowHrDetail=false"></HRDetail>
        </div>
    </Transition>
    <Transition>
        <div v-if="isShowAddHr" class="container" :class="{ container_filter: isShowAddHr }">
            <AddHr :user="user" @close="isShowAddHr=false"></AddHr>
        </div>
    </Transition>
    <div class="activity-container">
        <div class="activity-menu">
            <div class="activity-container-title">在线HR主页</div>
        ...
        <div class="activity-list">
            <HRList :user="user" ref="HRShort" @hr_selected="(value) => open_hr_detail(value)"></HRList>
        </div>
    </div>
</div>
